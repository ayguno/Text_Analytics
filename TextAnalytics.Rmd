...
New feature engineering idea: One way to use cosine similarity in a classification problem is to use **average similarity** between that particular data point and all other data points of the same class.If you calculate this for all data points in the training data, this will become a new feature and sometimes it is a powerfull feature.
